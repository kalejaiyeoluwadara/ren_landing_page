...
function MarketSection() {
  return (
    <div className="section-padding w-full flex items-start flex-col py-12">
      <section className="flex md:flex-row flex-col-reverse w-full justify-between items-center">
        <div>
          <Badge text="Customer’s" icon={<Icons.Time />} />
          <h2 className=" w-[80%] md:w-[420px]  mb-3">
            Happy customers, growing market presence
          </h2>
          <p className="text-gray-500 mb-6 md:w-[370px]">
